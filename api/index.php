...
<section class="myimage" id="about">
    <img src="public/port3.jpg" class="mine-img">
...
<section class="projects" id="projects">
    ...
    <div class="projects-container">
        ...
        <div class="project-container project-card">
            <img src="public/admin.PNG" class="project-pic">
        ...
        <div class="project-container project-card">
            <img src="public/bur.PNG" class="project-pic">
        ...
        <div class="project-container project-card">
            <img src="public/do.PNG" class="project-pic">
